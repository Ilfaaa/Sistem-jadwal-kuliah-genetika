            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input name="kode_dosen" type="text"
                       ...
                       value="{{ old('kode_dosen') }}" style="text-transform: uppercase;">
                @error('kode_dosen')
              ...
              <div class="form-group">
                ...
                <input name="nidn" type="text"
                       ...
                       id="nidn" placeholder="NIDN / NIP Dosen" value="{{ old('nidn') }}">
                @error('nidn')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="form-group">
                ...
                <select name="program_studi"
                  ...
                  @foreach($prodi as $p)
                    <option value="{{ $p->nama_prodi }}" {{ old('program_studi') == $p->nama_prodi ? 'selected' : '' }}>
