...
<section class="content">
  <div class="container-fluid">
    ...
    <a href="/managewaktu/managejam/create" class="btn btn-outline-greenTheme mb-2">
      <i class="fas fa-plus-circle mr-1"></i>Tambah Data Jam
    </a>
      ...
      <div class="col-12 col-md-6">
        <div class="card text-choTheme">
          <div class="card-header bg-greenTheme">
            ...
            <form method="post" action="/managewaktu/managejam/keyword">
              @csrf
              <div class="card-tools">
                <div class="input-group input-group-sm float-right" style="width: 250px;">
                  <input type="text" name="keyword" class="form-control float-right"
                         placeholder="Jam / Kode Jam" value="{{ old('keyword') }}">
          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-hover text-nowrap text-center">
              ...
              <tbody>
                @if(count($jam) == 0)
                  <tr>
                    <td scope="row" colspan="3" class="text-center text-bold text-danger">
                      Data Not Found!
                    </td>
                  </tr>
                @endif
                ...
                @foreach($jam as $j)
                  <tr>
                    <td scope="row">{{ $j->kode_jam }}</td>
                    <td scope="row">{{ $j->jam }}</td>
                    <td scope="row">
