          ...
          <form method="post" action="/managekelas">
            ...
            <div class="card-body table-responsive">
              <div class="form-group">
                ...
                <select name="prodi" id="select-prodi"
                  ...
                  @foreach($prodi as $p)
                    @php $valueProdi = $p->kode_prodi . '-' . $p->nama_prodi; @endphp
                    <option value="{{ $valueProdi }}" {{ old('prodi') == $valueProdi ? 'selected' : '' }}>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <select name="dosen_pengajar" id="select-dosen" disabled
              ...
              <p class="text-danger mb-0">
                <i>* Harap inputkan terlebih dahulu prodi, mata kuliah, dan dosen pengajar di menu manage prodi, mata kuliah, dan dosen.</i>
              </p>
            </div>
            <!-- /.card-body -->
