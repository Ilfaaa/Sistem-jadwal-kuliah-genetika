            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input name="nama" type="text"
                       ...
                       id="nama" placeholder="Nama User" value="{{ $user->name }}">
                @error('nama')
              ...
              <div class="form-group">
                ...
                <input name="username" type="text"
                       ...
                       id="username" placeholder="Username User" value="{{ $user->username }}">
                @error('username')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="form-group">
                ...
                <input name="email" type="text"
                       ...
                       id="email" placeholder="emailuser@gmail.com" value="{{ $user->email }}">
                @error('email')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="form-group">
                ...
                <div class="icheck-greenTheme d-inline ml-2">
                  ...
                  <label for="r-status1">Admin</label>
                </div>
                <div class="icheck-greenTheme d-inline ml-2">
                  <input type="radio" name="role_id" id="r-status2" value="2" {{ $user->role_id == 2 ? 'checked' : '' }}>
                  <label for="r-status2">Dosen</label>
                </div>
                <div class="icheck-greenTheme d-inline ml-2">
                  <input type="radio" name="role_id" id="r-status3" value="3" {{ $user->role_id == 3 ? 'checked' : '' }}>
                  <label for="r-status3">Mahasiswa</label>
                </div>
              </div>
              ...
              <p class="text-maroon mt-n3">
                <i><b>*Dilakukan Saat User Lupa Password</b></i>
              </p>
            </div>
